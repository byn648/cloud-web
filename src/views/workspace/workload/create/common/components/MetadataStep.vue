    ...
    <ElForm ref="formRef" :model="formData" :rules="rules" label-width="85px" class="step-form">
      ...
      <div class="config-section">
        ...
        <div class="items-list">
          <div class="item-row item-row-example">
            <ElInput model-value="version" readonly class="item-key" />
            <span class="equals">=</span>
            <ElInput model-value="v1" readonly class="item-value" />
            <span class="item-row-spacer" />
          </div>

          <div v-for="(label, index) in labels" :key="index" class="item-row">
            <ElInput
              v-model="label.key"
              placeholder="如 version"
              class="item-key"
              @input="handleInputChange"
            />
            <span class="equals">=</span>
      ...
      <div class="config-section">
        ...
        <div class="items-list">
          <div class="item-row item-row-example">
            <ElInput model-value="description" readonly class="item-key" />
            <span class="equals">=</span>
            <ElInput model-value="人脸识别在线推理服务" readonly class="item-value" />
            <span class="item-row-spacer" />
          </div>
