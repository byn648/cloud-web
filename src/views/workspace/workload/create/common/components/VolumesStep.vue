  ...
  <div class="volumes-step">
    <div class="volumes-panel">
      ...
      <div class="volumes-list">
        <div class="volume-item volume-item-example">
          <div class="volume-info">
            <div class="volume-name">模型文件</div>
            <ElTag size="small" type="success">PVC</ElTag>
            <div class="volume-desc">face-model-pvc</div>
          </div>
          <div class="volume-actions-spacer" />
        </div>
        ...
        <div v-if="volumes.length === 0" class="volumes-add-hint">
          <ElButton type="primary" @click="showAddDialog = true">
            <Plus :size="14" />
            添加第一个存储卷
          </ElButton>
